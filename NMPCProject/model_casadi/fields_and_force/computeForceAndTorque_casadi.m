...
%   modelId - MaglevModel.Accurate (default) or MaglevModel.Fast
    ...
    switch modelId
        ...
        otherwise  % MaglevModel.Accurate
            ...
            if nAxial == 1
                % Single axial slice: multiply by magnet length
                fx = magnet_l * inner_F(1);
                fy = magnet_l * inner_F(2);
                fz = magnet_l * inner_F(3);
                tx = magnet_l * inner_T(1);
                ty = magnet_l * inner_T(2);
                tz = magnet_l * inner_T(3);
            else
