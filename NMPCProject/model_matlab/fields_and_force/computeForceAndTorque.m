...
% the number of solenoids in params). modelId is either MaglevModel.Fast, 
% MaglevModel.Accurate or MaglevModel.Fillament.
%
% Example:
...
else% Default is MaglevModel.Fast or MaglevModel.Accurate with n_axial==1
