%% The following code is copied from sim_native.m, but uses a data driven controller rather than lqr.

% Initial conditions
% x = [x, y, z, alpha, beta, gamma, x_dot, y_dot, z_dot, alpha_dot,
%      beta_dot, gamma_dot]
...
%% Data driven control
% implements a parametric controller whoose parameters are determined by
% data driven tuning schemes. The structure of the controller is copied
% from the lqr controller.
T = readtable("params.csv");


K = [T.a0(1), 0, T.a1(1), 0, T.a2(1), 0, T.a3(1), 0, T.a4(1), 0, T.a5(1), 0;
     0, T.b0(1), T.b1(1), T.b2(1), 0, 0, 0, T.b3(1), T.b4(1), T.b5(1), 0, 0;
     T.c0(1), 0, T.c1(1), 0, T.c2(1), 0, T.c3(1), 0, T.c4(1), 0, T.c5(1), 0;
     0, T.d0(1), T.d1(1), T.d2(1), 0, 0, 0, T.d3(1), T.d4(1), T.d5(1), 0, 0;];
%%
...
% Simulation
tic
[t,x] = ode15s(@(t,x) f(x,K*(xLp-x)-uLp), tSpan, x0);

fprintf('D3C simulation time: %.2fs\n', toc)
