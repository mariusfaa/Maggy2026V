...
//  Input:
//
//    complex <double> X, the value whose norm is desired.
//
//  Output:
//
//    double C8_ABS, the magnitude of X.
//
{
  double value;
...
//  Input:
//
//    complex <double> C1, the argument.
//
//  Output:
//
//    complex <double> C8_ACOS, the function value.
//
{
  complex <double> c2;
  double c2_imag;
...
//  Output:
//
//    complex <double> C8_ACOSH, the function value.
//
{
  complex <double> c2;
...
//  Output:
//
//    complex <double> C8_I, the value of complex i.
//
{
  complex <double> value;
...
//  Purpose:
//
//    c8_le_li() := X <= Y for C8 values, and the Loo norm.
//
//  Discussion:
//
//    A C8 is a complex double precision value.
...
//
{
  ...
  if ( fmax ( fabs ( real ( x ) ), fabs ( imag ( x ) ) ) <= 
       fmax ( fabs ( real ( y ) ), fabs ( imag ( y ) ) ) )
  {
    value = true;
  }
  else
...
//  Output:
//
//    double C8_NORM_L1, the norm of X.
//
{
  double value;

  value = fabs ( real ( x ) ) + fabs ( imag ( x ) );
...
//
{
  ...
  value = fmax ( fabs ( real ( x ) ), fabs ( imag ( x ) ) );
...
//
//    complex <double> A[N1*N1], B[N1*N2], the matrices.
//
//  Output:
//
//    complex <double> C8MAT_MINVM_NEW[N1*N2], the result, 
//    C = inverse(A) * B.
//
{
  complex <double> *alu;
