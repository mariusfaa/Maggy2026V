...
filterPtr initObserver(int filterVariant, double dt, double xLp[NUMBER_OBSERVER_STATES], bool useSRformulation=0, int RK4Iterations=0, bool updateJacobians=1, bool updateQ=0, bool cubature=0, bool normalized=0);
