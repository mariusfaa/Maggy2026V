 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Apr 21 16:19:13 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                observerBlock
...
#define SOURCEFILES                    "__SFB__SRC_PATH ~/MSc/Maggy2026V/observer/PCobserver__SFB__LIB_PATH ~/MSc/Maggy2026V/observer/PCobserver/lib__SFB__LIB_PATH /usr/local/MATLAB/R2025b/bin/glnxa64__SFB__INC_PATH ~/MSc/Maggy2026V/observer/PCobserver/include/matlab__SFB__INC_PATH /usr/local/MATLAB/R2025b/extern/include__SFB__INC_PATH include__SFB__libmaglevModel.a__SFB__matrices.cpp__SFB__utilities.cpp__SFB__observer.cpp__SFB__libmwblas.so__SFB__libmwlapack.so"
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port input of S-Function observerBlock");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port meas of S-Function observerBlock");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port x_est of S-Function observerBlock");
      return;
    }
...
static void mdlStart(SimStruct *S)
{
  ...
  observerBlock_Start_wrapper(pW);
}
...
{
  void **pW = ssGetPWork(S);
  const real_T *input = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *meas = (real_T *) ssGetInputPortRealSignal(S, 1);
  real_T *x_est = (real_T *) ssGetOutputPortRealSignal(S, 0);
  observerBlock_Outputs_wrapper(input, meas, x_est, pW);
}
...
{
  void **pW = ssGetPWork(S);
  observerBlock_Terminate_wrapper(pW);
}
