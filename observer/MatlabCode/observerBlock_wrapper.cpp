...
#define ARMA_64BIT_WORD 1          // Use 64-bit integers (ILP64)
#define ARMA_BLAS_LONG_LONG 1      // Use 'long long' (64-bit) for BLAS calls [citation:6]
#define ARMA_BLAS_UNDERSCORE 1     // Match MATLAB's underscore naming (dgemm_)
#define ARMA_DONT_USE_WRAPPER 1    // Bypass armadillo's runtime wrapper [citation:6]
