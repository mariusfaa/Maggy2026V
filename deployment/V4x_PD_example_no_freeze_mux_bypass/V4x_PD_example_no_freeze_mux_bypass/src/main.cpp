...
// Control parameters
constexpr float Kp = 250;
constexpr float Kd = 3;
...
// Timing parameters
constexpr float sensorFrequency = 2000.0;
constexpr int sensorInterval = (int)(1e6 / sensorFrequency + 0.5);
constexpr float controlFrequency = 2000.0;
constexpr int controlInterval = (int)(1e6 / controlFrequency + 0.5);
